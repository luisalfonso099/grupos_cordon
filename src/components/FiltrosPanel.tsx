      ...
      {mostrarFiltros && (
        ...
        >
          ...
          <label style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
            <input type="checkbox" checked={mostrarPersonas} onChange={onToggleMostrar} />
            Mostrar personas
          </label>

          {/* 🗺 Mostrar/Ocultar territorios */}
          <label style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
            <input type="checkbox" checked={mostrarTerritorios} onChange={onToggleTerritorios} />
            Mostrar territorios
          </label>

          {/* 🧩 Mostrar/Ocultar grupos (polígonos) */}
          <label style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
            <input type="checkbox" checked={mostrarPoligonos} onChange={onTogglePoligonos} />
            Mostrar grupos
          </label>
